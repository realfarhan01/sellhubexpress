...
Public Class BusinessLogicLayer
    ...
    Public Function AddUpdateTourDepartures(ByVal PackageId As Integer, ByVal PackageName As String, ByVal DepartureDate As String, ByVal ShortDesc As String,
        ...
        Return result
    End Function
    Public Function AddUpdateOrderMaster(ByVal OrderId As Integer, ByVal TrackingNo As String, ByVal AWBNo As String, ByVal ShippingDate As String,
        ByVal ServiceProvider As String, ByVal Destination As String, ByVal ConsigneeName As String, ByVal DeliveryStatus As String) As String

        Dim result As String
        Dim arrList As New ArrayList
        arrList.Add(PrepareCommand("@OrderId", OrderId, SqlDbType.Int, 0, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@TrackingNo", TrackingNo, SqlDbType.VarChar, 100, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@AWBNo", AWBNo, SqlDbType.VarChar, 100, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@ShippingDate", ShippingDate, SqlDbType.VarChar, 100, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@ServiceProvider", ServiceProvider, SqlDbType.VarChar, 100, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Destination", Destination, SqlDbType.VarChar, 100, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@ConsigneeName", ConsigneeName, SqlDbType.VarChar, 100, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@DeliveryStatus", DeliveryStatus, SqlDbType.VarChar, 100, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Result", "", SqlDbType.VarChar, 200, ParameterDirection.Output))
        result = ExecNonQueryProc("Prc_AddUpdateOrderMaster", arrList.ToArray())
        Return result
    End Function
    Public Function AddOrderDetails(ByVal OrderId As Integer, ByVal Dated As String, ByVal DeliveryStatus As String, ByVal DeliveryDetails As String) As String
        Dim result As String
        Dim arrList As New ArrayList
        arrList.Add(PrepareCommand("@OrderId", OrderId, SqlDbType.Int, 0, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Dated", Dated, SqlDbType.VarChar, 100, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@DeliveryStatus", DeliveryStatus, SqlDbType.VarChar, 100, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@DeliveryDetails", DeliveryDetails, SqlDbType.NVarChar, 1000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Result", "", SqlDbType.VarChar, 200, ParameterDirection.Output))
        result = ExecNonQueryProc("Prc_AddOrderDetails", arrList.ToArray())
        Return result
    End Function
End Class
