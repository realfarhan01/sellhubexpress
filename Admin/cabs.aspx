<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" ValidateRequest="false" CodeFile="cabs.aspx.vb" Inherits="Admin_cabs" %>
...
<!-- Form components -->
            <div class="form-horizontal" >
                ...
                <div class="panel panel-default" id="div1" runat="server">
                    <div class="panel-heading"><h6 class="panel-title">Add/Edit Vehicles </h6> </div>
                    <div class="panel-body">
                       ...
                       <%-- <div class="alert alert-info fade in widget-inner">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Vehicle Image </label>
                            <div class="col-sm-10">
                ...
                <div class="panel-heading"><h6 class="panel-title">Vehicle List</h6>
                ...
                <div class="table-responsive">
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                             ...
                             <asp:BoundField DataField="VehicleName" HeaderText="Vehicle Name"></asp:BoundField>
                             <asp:TemplateField>
                                 <ItemTemplate>
                                     <a href='../images/vehicles/<%#Eval("ImageName") %>' target="_blank" >
                                    <img style="width:150px" alt="" src='../images/vehicles/<%#Eval("ImageName") %>'></img></a>
                                 </ItemTemplate>
                             </asp:TemplateField>
