...
Partial Class Admin_Destinations2
    Inherits BasePage
        ...
        Try
            ...
            If FUImage.HasFile And BLL.isImage(FUImage.FileContent) Then
                If FUImage.PostedFile.ContentLength <= 2097152 And FUImage.PostedFile.ContentType.Split("/")(0) = "image" Then
                    ...
                    FUImage.SaveAs(Server.MapPath("../images/destinations/origional/" + RandomStr))
                    ResizeImageAndSave(800, 800, Context.Server.MapPath("../images/destinations/origional/" & RandomStr), "../images/destinations/" + RandomStr)
                End If
            End If
            BLL.AddNews(hfId.Value, txttitle.Text, "", "Destination", RandomStr, "", "", txtNews.Text, ddlStatus.SelectedValue)
            hfId.Value = 0
