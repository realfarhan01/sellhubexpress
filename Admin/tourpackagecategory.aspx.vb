...
Partial Class Admin_tourpackagemaster
    ...
    Protected Sub btnsubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            ...
            BLL.ExecNonQueryProc("AddUpdate_ProductCategory", "@ProductCategoryId", hfId.Value, "@UserName", user, "@ProductCategory", txtProductCategory.Text, "@ProductCategoryImage", File, "@BannerImage", File2, "@ShortDesc", txtShortDesc.Text, "@DeActivated", ddlStatus.SelectedValue, "@PageURL", PageURL)
            showdata()
            div1.Visible = False
            div2.Visible = True
